        ...
        class SunCalcControl extends L.Control {
            ...
            updateSunMoonCalc() {
                ...
                requestAnimationFrame(function () {
                    self._map.sunCalcControl.refesh(SunCalc.getTimes(currentDate, mapCenter.lat, mapCenter.lng), SunCalc.getMoonTimes(currentDate, mapCenter.lat, mapCenter.lng), mapCenter);
                });
                this._previousCenter = mapCenter;
                this._previousDate = currentDate;
            }
            ...
            refesh(sunTimes, moonTimes, latlng) {
                ...
                if (!this._map.hasLayer(suncalc)) {
                    ...
                    const circleSize = this.circleSize = (_c = Math.min(Math.min((_a = window === null || window === void 0 ? void 0 : window.innerWidth) !== null && _a !== void 0 ? _a : parent.innerWidth, (_b = window === null || window === void 0 ? void 0 : window.innerHeight) !== null && _b !== void 0 ? _b : parent.innerHeight) - 80, 512)) !== null && _c !== void 0 ? _c : 300;
...
//# sourceMappingURL=SunCalcControl.js.map